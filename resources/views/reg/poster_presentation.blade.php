        ...
        @elseif($registrationStatus === 'open')
            ...
            <div class="registration-content">
                ...
                <div class="qr-container">
                    <a href="https://forms.gle/Nh25Vpgn2cHujjEm7" target="_blank">
                        <img src="{{ asset('user_view/images/Poster_Presentation.png') }}" alt="QR Code" class="qr-code">
                    </a>
                </div>
                ...
                <a href="https://forms.gle/Nh25Vpgn2cHujjEm7" class="google-form-btn">
