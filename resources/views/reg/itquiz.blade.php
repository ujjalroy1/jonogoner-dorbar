        ...
        @elseif($registrationStatus === 'open')
            ...
            <div class="registration-content">
                ...
                <div class="qr-container">
                    <a href="https://forms.gle/DhUCJiNcxMp2udDj7" target="_blank">
                        <img src="{{ asset('user_view/images/IT_Quiz.png') }}" alt="QR Code" class="qr-code">
                    </a>
                </div>
                ...
                <a href="https://forms.gle/DhUCJiNcxMp2udDj7" class="google-form-btn">
